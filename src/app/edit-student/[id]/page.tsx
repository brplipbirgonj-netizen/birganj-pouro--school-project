...
import { Upload, ArrowRight, ArrowLeft, CheckCircle2, User, Users, Home, GraduationCap, Trash2 } from 'lucide-react';
...
export default function EditStudentPage() {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-rose-100 font-kalpurush">
      <Header />
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                      ...
                      <AlertDialogAction onClick={handleDelete} className="bg-destructive text-destructive-foreground hover:bg-destructive/90 font-black">ডিলিট করুন</AlertDialogAction>
                    </AlertDialogFooter>
                  </AlertDialogContent>
                </AlertDialog>
            </div>
              ...
              <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
                  ...
                  <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                      ...
                      <div className="space-y-2 md:col-span-2 lg:col-span-1">
                          <Label htmlFor="previousSchool">পূর্ববর্তী বিদ্যালয়ের নাম</Label>
                          <Input id="previousSchool" value={student.previousSchool || ''} onChange={e => handleInputChange('previousSchool', e.target.value)} className={inputFocusClasses} />
                      </div>

                      {student.className && (
                          <div className="space-y-2">
                              <Label htmlFor="prevRegNo">
                              ...
                              <Input id="prevRegNo" value={student.prevRegNo || ''} onChange={e => handleInputChange('prevRegNo', e.target.value)} className={inputFocusClasses} />
                          </div>
                      )}
                      ...
                      {(student.className === '9' || student.className === '10') && (
                          <>
                            <div className="space-y-2">
                                <Label htmlFor="prevPassingYear">পাসের সন (জেএসসি/জেডিসি)</Label>
                                <Input id="prevPassingYear" value={student.prevPassingYear || ''} onChange={e => handleInputChange('prevPassingYear', e.target.value)} className={inputFocusClasses} />
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="prevBoard">বোর্ডের নাম</Label>
                                <Select value={student.prevBoard || ''} onValueChange={v => handleInputChange('prevBoard', v)}>
                                    <SelectTrigger className={inputFocusClasses}><SelectValue placeholder="বোর্ড" /></SelectTrigger>
                                    <SelectContent>
                                        {boards.map(b => (
