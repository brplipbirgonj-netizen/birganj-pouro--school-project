            ...
            <form className="space-y-8" onSubmit={handleSubmit}>
              ...
              <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
                  ...
                  <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                      ...
                      {/* Common: Previous School */}
                      <div className="space-y-2 md:col-span-2 lg:col-span-1">
                          <Label htmlFor="previousSchool">পূর্ববর্তী বিদ্যালয়ের নাম</Label>
                          <Input id="previousSchool" value={student.previousSchool || ''} onChange={e => handleInputChange('previousSchool', e.target.value)} className={inputFocusClasses} placeholder="আগের স্কুলের নাম লিখুন" />
                      </div>
                      ...
                      {student.className && (
                          <div className="space-y-2">
                              ...
                              <Input id="prevRegNo" value={student.prevRegNo || ''} onChange={e => handleInputChange('prevRegNo', e.target.value)} className={inputFocusClasses} placeholder="রেজিষ্ট্রেশন নম্বর" />
                          </div>
                      )}
                      ...
                      {(student.className === '9' || student.className === '10') && (
                        <>
                          <div className="space-y-2">
                              ...
                              <Input id="prevPassingYear" value={student.prevPassingYear || ''} onChange={e => handleInputChange('prevPassingYear', e.target.value)} className={inputFocusClasses} placeholder="উদা: ২০২৪" />
                          </div>
                          <div className="space-y-2">
                              <Label htmlFor="prevBoard">বোর্ডের নাম</Label>
                              <Select value={student.prevBoard || ''} onValueChange={v => handleInputChange('prevBoard', v)}>
                                  <SelectTrigger className={inputFocusClasses}><SelectValue placeholder="বোর্ড নির্বাচন করুন" /></SelectTrigger>
                                  <SelectContent>
                                      {boards.map(b => (
