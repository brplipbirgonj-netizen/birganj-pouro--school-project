...
const createInitialRoutine = async (db: Firestore, academicYear: string): Promise<ClassRoutine[]> => {
    ...
    '6': {
        'রবিবার': ['বাংলা ১ম - ওবায়দা', 'গণিত - ধনঞ্জয়', 'বিজ্ঞান - শান্তি আরা', 'বাও বি - জান্নাতুন', 'বাংলা ২য় - যুধিষ্ঠির', 'আইসিটি - শারমিন', ''],
        'সোমবার': ['কৃষি - জান্নাতুন', 'বাংলা ২য় - যুধিষ্ঠির', 'আইসিটি - শারমিন', 'বাও বি - জান্নাতুন', 'বাংলা ১ম - ওবায়দা', 'বিজ্ঞান - শান্তি আরা', ''],
        ...
        'বৃহস্পতিবার': ['বাও বি - জান্নাতুন', 'বাংলা ২য় - যুধিষ্ঠির', 'ইংরেজি ১ম - আরিফুর', 'বাংলা ১ম - ওবায়দা', 'ইংরেজি ২য় - যুধিষ্ঠির', 'বিজ্ঞান - শান্তি আরা', ''],
    },
    '7': {
        'রবিবার': ['ইংরেজি ১ম - আরিফুর', 'শারীরিক - ওবায়দা', 'কৃষি - মাহাবুর', 'ধর্ম - আনিছুর/নীলা', 'বিজ্ঞান - শান্তি আরা', 'ইংরেজি ২য় - যুধিষ্ঠির', ''],
        'সোমবার': ['গণিত - ধনঞ্জয়', 'আইসিটি - শারমিন', 'বাও বি - আনিছুর', 'কৃষি - মাহাবুর', 'কৃষি - মাহাবুর', 'শারীরিক - ওবায়দা', ''],
        'মঙ্গলবার': ['কৃষি - মাহাবুর', 'বাংলা ২য় - যুধিষ্ঠির', 'বিজ্ঞান - শান্তি আরা', 'গণিত - ধনঞ্জয়', 'ধর্ম - আনিছুর/নীলা', 'বাও বি - আনিছুর', ''],
        'বুধবার': ['বাংলা ১ম - ওবায়দা', 'ইংরেজি ১ম - আরিফুর', 'ইংরেজি ২য় - আরিফুর', 'কৃষি - মাহাবুর', 'গণিত - ধনঞ্জয়', 'শারীরিক - ওবায়দা', ''],
        'বৃহস্পতিবার': ['গণিত - ধনঞ্জয়', 'বাও বি - আনিছুর', 'ইংরেজি ২য় - আরিফুর', 'বিজ্ঞান - শান্তি আরা', 'ধর্ম - আনিছুর/নীলা', 'বাংলা ১ম - ওবায়দা', ''],
    },
    '8': {
        'রবিবার': ['বাংলা ২য় - যুধিষ্ঠির', 'ধর্ম - মাহাবুর/নীলা', 'ইংরেজি ১ম - আরিফুর', 'বিজ্ঞান - শান্তি আরা', 'বাংলা ১ম - ওবায়দা', 'বাও বি - আনিছুর', ''],
        ...
        'বৃহস্পতিবার': ['শারীরিক - নীলা', 'কৃষি - জান্নাতুন', 'গণিত - ধনঞ্জয়', 'কৃষি - জান্নাতুন', 'ইংরেজি ১ম - আরিফুর', 'বিজ্ঞান - শান্তি আরা', ''],
    },
    '9': {
        'রবিবার': ['গণিত - ধনঞ্জয়', 'জীব/পৌরনীতি - শান্তি আরা/জান্নাতুন', 'রসায়ন/ভূগোল - ধনঞ্জয়/শারমিন', 'বাংলা ২য় - যুধিষ্ঠির', 'রসায়ন/ভূগোল - ধনঞ্জয়/শারমিন', 'বাও বি/বিজ্ঞান - আনিছুর/শান্তি আরা', ''],
        'সোমবার': ['আইসিটি - শারমিন', 'গণিত - ধনঞ্জয়', 'জীব/পৌরনীতি - শান্তি আরা/জান্নাতুন', 'ইংরেজি ১ম - আরিফুর', 'গণিত - ধনঞ্জয়', 'রসায়ন/ভূগোল - ধনঞ্জয়/শারমিন', ''],
        'মঙ্গলবার': ['গণিত - ধনঞ্জয়', 'বাংলা ১ম - ওবায়দা', 'পদার্থ/ইতিহাস - ধনঞ্জয়/জান্নাতুন', 'জীব/পৌরনীতি - শান্তি আরা/জান্নাতুন', 'ধর্ম - মাহাবুর/নীলা', 'বাও বি/বিজ্ঞান - আনিছুর/শান্তি আরা', ''],
        'বুধবার': ['ইংরেজি ২য় - আরিফুর', 'পদার্থ/ইতিহাস - ধনঞ্জয়/জান্নাতুন', 'কৃষি - মাহাবুর', 'শারীরিক - মাহাবুর', 'উচ্চতর গণিত - ধনঞ্জয়', 'কৃষি - মাহাবুর', ''],
        'বৃহস্পতিবার': ['পদার্থ/ইতিহাস - ধনঞ্জয়/জান্নাতুন', 'গণিত - ধনঞ্জয়', 'রসায়ন/ভূগোল - ধনঞ্জয়/শারমিন', 'শারীরিক - মাহাবুর', 'উচ্চতর গণিত - ধনঞ্জয়', 'ধর্ম - মাহাবুর/নীলা', ''],
    },
    '10': {
        'রবিবার': ['আইসিটি - শারমিন', 'জীব/পৌরনীতি - শান্তি আরা/জান্নাতুন', 'বাংলা ২য় - যুধিষ্ঠির', 'ইংরেজি ১ম - আরিফুর', 'বাংলা ১ম - ওবায়দা', 'গণিত - ধনঞ্জয়', ''],
        'সোমবার': ['আইসিটি - শারমিন', 'ধর্ম - মাহাবুর/নীলা', 'জীব/পৌরনীতি - শান্তি আরা/জান্নাতুন', 'বাও বি - আনিছুর', 'গণিত - ধনঞ্জয়', 'আইসিটি - শারমিন', ''],
        'মঙ্গলবার': ['আইসিটি - শারমিন', 'ইংরেজি ২য় - আরিফুর', 'ধর্ম - মাহাবুর/নীলা', 'ইংরেজি ২য় - আরিফুর', 'জীব/পৌরনীতি - শান্তি আরা/জান্নাতুন', 'কৃষি - মাহাবুর', ''],
        'বুধবার': ['আইসিটি - শারমিন', 'বাংলা ১ম - ওবায়দা', 'বাংলা ২য় - যুধিষ্ঠির', 'বাংলা ১ম - ওবায়দা', 'ধর্ম - মাহাবুর/নীলা', 'ইংরেজি ১ম - আরিফুর', ''],
