...
export const StudentIDCard = ({ student, schoolInfo, isPrint = false }: StudentIDCardProps) => {
    return (
        <div className={cn(
            ...
            <div className="absolute top-0 left-0 right-0 h-24 bg-primary clip-header-path"></div>
            
            <header className="relative z-10 flex flex-col items-center pt-2 pb-1 text-white">
                {schoolInfo.logoUrl && (
                    <div className="w-10 h-10 bg-white rounded-full p-1 shadow-md mb-1">
                        <Image src={schoolInfo.logoUrl} alt="Logo" width={40} height={40} className="object-contain w-full h-full" />
                    </div>
                )}
                <h1 className={cn(
                    "font-black text-center leading-none px-2",
            ...
            <main className="relative z-10 flex-1 flex flex-col items-center pt-2 px-4">
                ...
                <div className="relative mb-3">
                    ...
                    <div className={cn(
                        "relative border-2 border-primary bg-white overflow-hidden rounded-lg",
                ...
                {/* Identity Title */}
                <div className="bg-primary text-white px-4 py-0.5 rounded-full mb-3 shadow-sm">
                ...
                <div className="w-full space-y-1 text-left">
                    <div className="flex flex-col items-center mb-2">
                        <h2 className={cn("font-black text-primary leading-tight", isPrint ? "text-sm" : "text-lg")}>
            ...
            {/* Footer / Signature */}
            <footer className="relative z-10 pt-4 pb-3 flex flex-col items-center">
